package com.newproject.download.security;
...
/**
 * SECURITY (H3): risolve l'identita' autenticata (customerId via header iniettato dal gateway,
 * ruolo ADMIN via authority del JWT) e impone lo scoping per-owner sulle risorse di download.
 * Copia header-based, allineata a reward/transaction-service.
 */
@Component
